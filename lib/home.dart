...
import 'package:ebook/UI/app_color.dart' as AppColors  ;
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    const Icon(Icons.menu_outlined, size: 25,),
                    Row(
                      children: const [
                        Icon(Icons.search),
                        SizedBox(width: 10,),
              ...
              //TEXT BETWEEN TITLE BAR AND POSTERS
              Row(
                children: [
                  Container(
                    margin: const EdgeInsets.only(left: 20),
                    child: const Text("Populour Books",style: TextStyle(
                      fontSize: 30
                    ),),
                  )
                ],
                         ...
                         child: Container(
                           ...
                           child:Row(
                             ...
                             decoration: BoxDecoration(
                               borderRadius: BorderRadius.circular(10),
                                image: DecorationImage(
                                 // image: AssetImage("assets/img/poster1.jpeg")
                               ...
                               Column(
                                ...
                                Row(
                                  children: [
                                   ...
                                   Text(books[i]["title"],style: const TextStyle(fontSize: 16,fontFamily: "Ayenir",fontWeight: FontWeight.bold),),
                                   Text(books[i]["text"],style: TextStyle(fontSize: 16,fontFamily: "Ayenir",color: AppColors.subTitleText),),
                                   Container(
                                     width: 60,
                                       height: 15,
                                       decoration: BoxDecoration(
                                      ...
                                      alignment:Alignment.center,
                                       child: const Text("Love",style: TextStyle(fontSize: 12,fontFamily: "Ayenir",fontWeight: FontWeight.bold,color:Colors.white),),
                                   ),
